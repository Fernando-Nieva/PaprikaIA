        ...
        <div className="input-container">
          ...
          >
            <input
              ...
              accept="image/jpeg,image/png,image/gif,image/webp,audio/mpeg,audio/wav,audio/ogg,audio/webm,audio/mp4,application/pdf,text/plain,text/markdown,text/csv,application/json,.docx,.doc"
              multiple
